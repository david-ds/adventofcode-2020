...
int run(const char* s) {
    ...
    while (s[i] && !(s[i] == '\n' && s[i+1] == '\n')) {
        ...
        rules[id].litteral = 0;
        if (id == 8) {
            rules[id].r_or_size = 2;
            rules[id].r_or_sizes[0] = 1;
            rules[id].r_or_sizes[1] = 2;
            rules[id].r_or[0][0] = 42;
            rules[id].r_or[1][0] = 42;
            rules[id].r_or[1][1] = 8;
            while (s[i] != '\n') i++;
            continue;
        }
        if (id == 11) {
            rules[id].r_or_size = 2;
            rules[id].r_or_sizes[0] = 2;
            rules[id].r_or_sizes[1] = 3;
            rules[id].r_or[0][0] = 42;
            rules[id].r_or[0][1] = 31;
            rules[id].r_or[1][0] = 42;
            rules[id].r_or[1][1] = 11;
            rules[id].r_or[1][2] = 31;
            while (s[i] != '\n') i++;
            continue;
        }
