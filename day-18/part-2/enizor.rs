...
mod tests {
    ...
    #[test]
    fn run_test() {
        assert_eq!(evaluate(&"1 + 2 * 3".as_bytes()), 9);
        assert_eq!(evaluate(&"1 + 2 * 3 + 4 * 5 + 6".as_bytes()), 231);
        assert_eq!(evaluate(&"1 + (2 * 3) + (4 * (5 + 6))".as_bytes()), 51);
        assert_eq!(evaluate(&"2 * 3 + (4 * 5)".as_bytes()), 46);
        assert_eq!(evaluate(&"5 + (8 * 3 + 9 + 3 * 4 * 3)".as_bytes()), 1445);
        assert_eq!(
